...
{
    public partial class YemekCesitGuncelleForm : Form
    {
        public YemekCesitGuncelleForm()
        {
            InitializeComponent();
        }
        ...
        private void YemekCesitGuncelleForm_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string eskiYemekAd = textBox5.Text;
            ...
            //hiç malzeme seçilmemil 
            if (malzemelers.Count == 0)
            {
                MessageBox.Show("Lütfen en az bir adet malzeme seçiniz!", "Hata");
            ...
            else 
            {
                ...
                string durum = yemekCesitYonetimi.YemekCesitGuncelle(eskiYemekAd, yiyecek, malzemelers);
        ...
        {
            YemekCesitYonetimi yemekCesitYonetimi = new YemekCesitYonetimi();
            string yemekAdEski = textBox5.Text;


            var gelenYemekBilgi = yemekCesitYonetimi.YemekCesitListeleTekli(yemekAdEski);

            //egerki yoksa sa bir hata var demek
            if(gelenYemekBilgi == null) 
            {
                MessageBox.Show("Bir hata var\nMuhtemelen bir veri yok!", "Hata!");
            }
            else 
            {
                textBox1.Text = gelenYemekBilgi.yiyecekAdi;
                comboBox1.SelectedItem = gelenYemekBilgi.yiyecekCins;
                textBox4.Text = gelenYemekBilgi.yiyecekFiyat.ToString();
                textBox3.Text = gelenYemekBilgi.yiyecekKackisi.ToString();
                textBox2.Text = gelenYemekBilgi.yiyecekKDV.ToString();
            }
